...
{
	public class InterpellationFragment : BaseFragment
	{
		...
		private IInterpellation interpellation;
		...
		public override void OnCreate (Bundle savedInstanceState)
		{
			...
			{
				(Activity as BaseActivity).ShowErrorDialog ("Nieprawidłowe informacje o interpelacji");
				Activity.Finish ();
			}
		}
