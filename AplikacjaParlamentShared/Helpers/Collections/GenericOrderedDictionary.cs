...
namespace AplikacjaParlamentShared.Collections
{
	...
	public class GenericOrderedDictionary<TKey, TValue> : IOrderedDictionary<TKey, TValue> {
		...
		public GenericOrderedDictionary(IEqualityComparer<TKey> comparer) {
			Initialize(comparer);
		}

		public GenericOrderedDictionary(IOrderedDictionary<TKey, TValue> dictionary) {
			Initialize();
		...
		public GenericOrderedDictionary(IOrderedDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) {
			Initialize(comparer);
			foreach (KeyValuePair<TKey, TValue> pair in dictionary) {
				_keyedCollection.Add(pair);
			}
